...
4. Set a `Nick` aka _username_ for your current instance.<br>
...
5. Now Goto `Connection` > `Advanced` > `TLS settings` and choose `Allow TLS`.<br>
...
8. Press `cmd + N`, key-combination for quick connect.<br>
...
9. You should now be connected to the hub and if the fonts are set properly you should see something like this
